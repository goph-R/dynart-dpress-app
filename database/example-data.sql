...
INSERT INTO `dp_content_aud` VALUES (1,'post',NULL,1,1,'Welcome to dpress','welcome-to-dpress','This is the lead. Everything before the separator shows up in listings, and only that.\r\n\r\n---\r\n\r\n## And this is the body\r\n\r\nThe body is everything after the first line that is nothing but three dashes. A post with no\r\nseparator is all lead and no body, which is exactly what a short note is.\r\n\r\nMarkdown works as you would expect: **bold**, *italic*, `inline code` and [links](https://example.com).\r\n\r\n- a list item\r\n- another one\r\n\r\n> A blockquote, for good measure.','<p>This is the lead. Everything before the separator shows up in listings, and only that.</p>\n','<h2>And this is the body</h2>\n<p>The body is everything after the first line that is nothing but three dashes. A post with no\nseparator is all lead and no body, which is exactly what a short note is.</p>\n<p>Markdown works as you would expect: <strong>bold</strong>, <em>italic</em>, <code>inline code</code> and <a href=\"https://example.com\">links</a>.</p>\n<ul>\n<li>a list item</li>\n<li>another one</li>\n</ul>\n<blockquote>\n<p>A blockquote, for good measure.</p>\n</blockquote>\n','published','2026-08-04 17:13:38','2026-08-04 17:13:38','2026-08-04 17:13:38',2,'mod'),(1,'post',NULL,1,1,'Welcome to dpress!','welcome-to-dpress','This is the lead. Everything before the separator shows up in listings, and only that.\r\n\r\n---\r\n\r\n## And this is the body\r\n\r\nThe body is everything after the first line that is nothing but three dashes. A post with no\r\nseparator is all lead and no body, which is exactly what a short note is.\r\n\r\nMarkdown works as you would expect: **bold**, *italic*, `inline code` and [links](https://example.com).\r\n\r\n- a list item\r\n- another one\r\n\r\n> A blockquote, for good measure.','<p>This is the lead. Everything before the separator shows up in listings, and only that.</p>\n','<h2>And this is the body</h2>\n<p>The body is everything after the first line that is nothing but three dashes. A post with no\nseparator is all lead and no body, which is exactly what a short note is.</p>\n<p>Markdown works as you would expect: <strong>bold</strong>, <em>italic</em>, <code>inline code</code> and <a href=\"https://example.com\">links</a>.</p>\n<ul>\n<li>a list item</li>\n<li>another one</li>\n</ul>\n<blockquote>\n<p>A blockquote, for good measure.</p>\n</blockquote>\n','published','2026-08-04 17:13:38','2026-08-04 17:13:38','2026-08-04 17:13:38',3,'mod'),(2,'post',NULL,2,NULL,'Árvíztűrő tükörfúrógép','arvizturo-tukorfurogep','Az ékezetes címekből is olvasható URL lesz, mert a slug az ékezeteket az alapbetűre képezi le.\r\n\r\n---\r\n\r\nEz a törzsszöveg. A cím slugja `arvizturo-tukorfurogep` lett, nem pedig kötőjelek sora.','<p>Az ékezetes címekből is olvasható URL lesz, mert a slug az ékezeteket az alapbetűre képezi le.</p>\n','<p>Ez a törzsszöveg. A cím slugja <code>arvizturo-tukorfurogep</code> lett, nem pedig kötőjelek sora.</p>\n','published','2026-08-04 17:13:38','2026-08-04 17:13:38','2026-08-04 17:13:38',2,'add'),(3,'post',NULL,2,NULL,'A short note','a-short-note','No separator here, so the whole thing is the lead and there is no body.','<p>No separator here, so the whole thing is the lead and there is no body.</p>\n','','published','2026-08-04 17:13:38','2026-08-04 17:13:38','2026-08-04 17:13:38',2,'add'),(4,'post',NULL,1,NULL,'Something unfinished','something-unfinished','A draft. Visitors get a 404; anybody who may edit posts can preview it.\n\n---\n\nStill being written.','<p>A draft. Visitors get a 404; anybody who may edit posts can preview it.</p>\n','<p>Still being written.</p>\n','draft',NULL,'2026-08-04 17:13:38','2026-08-04 17:13:38',2,'add'),(5,'page',NULL,1,NULL,'About','about','About this site.\n\n---\n\nPages are hierarchical. This one has a child.','<p>About this site.</p>\n','<p>Pages are hierarchical. This one has a child.</p>\n','published','2026-08-04 17:13:38','2026-08-04 17:13:38','2026-08-04 17:13:38',2,'add'),(6,'page',5,1,NULL,'Contact','contact','How to get in touch.','<p>How to get in touch.</p>\n','','published','2026-08-04 17:13:38','2026-08-04 17:13:38','2026-08-04 17:13:38',2,'add');
...
INSERT INTO `dp_media` VALUES (1,'2026/08/sunset-photo-e6dd2d.jpg','Sunset Photo.jpg','image/jpeg','image',24991,1200,800,'Example Sunset Photo',NULL,NULL,1,'2026-08-04 17:13:38','2026-08-04 17:13:38',NULL),(2,'2026/08/icon-85e1b2.svg','icon.svg','image/svg+xml','image',113,NULL,NULL,'Example icon',NULL,NULL,1,'2026-08-04 17:13:38','2026-08-04 17:13:38',NULL),(3,'2026/08/logo-a02c1d.png','logo.png','image/png','image',897,300,300,'Example logo',NULL,NULL,1,'2026-08-04 17:13:38','2026-08-04 17:13:38',NULL),(4,'2026/08/notes-312b3b.txt','notes.txt','text/plain','document',14,NULL,NULL,'Example notes',NULL,NULL,1,'2026-08-04 17:13:38','2026-08-04 17:13:38',NULL);
...
INSERT INTO `dp_media_aud` VALUES (1,'2026/08/sunset-photo-e6dd2d.jpg','Sunset Photo.jpg','image/jpeg','image',24991,1200,800,'Example Sunset Photo',NULL,NULL,1,'2026-08-04 17:13:38','2026-08-04 17:13:38',NULL,2,'add'),(2,'2026/08/icon-85e1b2.svg','icon.svg','image/svg+xml','image',113,NULL,NULL,'Example icon',NULL,NULL,1,'2026-08-04 17:13:38','2026-08-04 17:13:38',NULL,2,'add'),(3,'2026/08/logo-a02c1d.png','logo.png','image/png','image',897,300,300,'Example logo',NULL,NULL,1,'2026-08-04 17:13:38','2026-08-04 17:13:38',NULL,2,'add'),(4,'2026/08/notes-312b3b.txt','notes.txt','text/plain','document',14,NULL,NULL,'Example notes',NULL,NULL,1,'2026-08-04 17:13:38','2026-08-04 17:13:38',NULL,2,'add');
...
INSERT INTO `dp_migration_history` VALUES ('0001_create_revision_table','2026-08-04 17:13:37'),('0002_create_identity_tables','2026-08-04 17:13:37'),('0003_create_media_tables','2026-08-04 17:13:37'),('0004_create_content_tables','2026-08-04 17:13:37'),('0005_create_taxonomy_tables','2026-08-04 17:13:37'),('0006_create_menu_and_setting_tables','2026-08-04 17:13:38');
...
INSERT INTO `dp_revision` VALUES (1,'2026-08-04 17:13:37',NULL),(2,'2026-08-04 17:13:38',NULL),(3,'2026-08-04 17:13:38','2');
...
INSERT INTO `dp_setting` VALUES ('registration_open','1','2026-08-04 17:13:38'),('site_name','dpress dev','2026-08-04 17:13:38');
...
INSERT INTO `dp_setting_aud` VALUES ('registration_open','1','2026-08-04 17:13:38',2,'add'),('site_name','dpress dev','2026-08-04 17:13:38',2,'add');
...
INSERT INTO `dp_user` VALUES (1,'admin@example.com','$2y$10$wuUVcdcqf4rKzR1zxw7Rlu0/iUxjV.FucsaOyIRjXcaOAZoIQMTpy','Site Admin','active','2026-08-04 17:13:38','2026-08-04 17:13:38'),(2,'editor@example.com','$2y$10$wEaJeXHCfPGM.UI6zmHrLu.jUE2.2qWnIWzHKprcukaiOEIpuLTrG','Edit Everything','active','2026-08-04 17:13:38','2026-08-04 17:13:38'),(3,'reader@example.com','$2y$10$n9/4OcpBCvXduqznNOni/.YpXw20pTsixnPijMpXjjfUeKlL0opX6','Ray Reader','active','2026-08-04 17:13:38','2026-08-04 17:13:38'),(4,'pending@example.com','$2y$10$hSv5lt/rLed3T2SwpeyUBe9r8ZuT4K9a6IJsGH7mLLNLmHxO/pfme','Penny Pending','pending','2026-08-04 17:13:38','2026-08-04 17:13:38');
...
INSERT INTO `dp_user_aud` VALUES (1,'admin@example.com','$2y$10$wuUVcdcqf4rKzR1zxw7Rlu0/iUxjV.FucsaOyIRjXcaOAZoIQMTpy','Site Admin','active','2026-08-04 17:13:38','2026-08-04 17:13:38',2,'add'),(2,'editor@example.com','$2y$10$wEaJeXHCfPGM.UI6zmHrLu.jUE2.2qWnIWzHKprcukaiOEIpuLTrG','Edit Everything','active','2026-08-04 17:13:38','2026-08-04 17:13:38',2,'add'),(3,'reader@example.com','$2y$10$n9/4OcpBCvXduqznNOni/.YpXw20pTsixnPijMpXjjfUeKlL0opX6','Ray Reader','active','2026-08-04 17:13:38','2026-08-04 17:13:38',2,'add'),(4,'pending@example.com','$2y$10$hSv5lt/rLed3T2SwpeyUBe9r8ZuT4K9a6IJsGH7mLLNLmHxO/pfme','Penny Pending','pending','2026-08-04 17:13:38','2026-08-04 17:13:38',2,'add');
